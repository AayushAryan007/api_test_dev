...
SECRET_KEY = 'django-insecure-#8-n&$74!^7#c@2v0w4te@6mw55afxxz)9lvnhu_#!+1v^!2i_'
...
MIDDLEWARE = [
    ...
    # custom middleware (runs after AuthenticationMiddleware)
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'proj1'),
        'USER': os.environ.get('DB_USER', 'proj1user'),
        'PASSWORD': os.environ.get('DB_PASS', 'proj1pass'),
